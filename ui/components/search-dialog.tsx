  ...
  return (
    <>
      <button
        ...
        className={`bg-white font-semibold hover:bg-white hover:text-white px-4 ${props.isOpen ? 'py-5' : 'py-4'} text-xs uppercase tracking-wide text-brand-blue-dark flex-shrink-0 flex items-center`}
        >
