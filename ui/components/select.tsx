  ...
  return (
    <Listbox disabled={disabled} value={value} onChange={onChange}>
      <div className="relative w-full">
        ...
        <Listbox.Options className="absolute w-auto left-0 right-0 py-1 mt-1 overflow-auto text-base bg-white shadow-lg max-h-48 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-20">
          {options.map((option) => (
            <Listbox.Option
