    ...
    <Layout countries={countries}>
      <section className="h-full flex flex-col">
        <div className="w-full lg:divide-x grid lg:grid-cols-12 h-full bg-gradient-to-l from-blue-50">
          <div className="items-center justify-center py-8 px-8 lg:py-0 lg:px-12 xl:px-16 col-span-full lg:col-span-5">
          ...
          <div className="col-span-full lg:col-span-7 overflow-hidden relative">
            <motion.div
              className="h-full"
            ...
            <AnimatePresence>
              {activeCountry && (
                <motion.div
                  ...
                  className="absolute right-4 bottom-4 max-w-[340px]"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                >
